import { Box, Button, IconButton, Typography, useTheme, Snackbar, TextField } from "@mui/material";
...
const Engagements = () => {
    ...
    const columns = [
        ...
        },
        {
          ...
          },
          {
            ...
            type: "actions",
            width: 150,
            renderCell: (params) => <EngagementDialog {...{ params, handleDelete, handleEngagementUpdate }}  />,
          },
      ];
  ...
  return (
    <Box m="20px">
      ...
      <UpdateEngagement openModal={openModal} handleCloseModal={handleCloseModal} rowId={rowId} />
    </Box>
    )
}
